  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php 
            $query = "SELECT * FROM webinar ORDER BY id_webinar";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- Default box -->
            <a href="tambah_kegiatan_webinar.php" class="btn btn-primary mb-2">
        ...
        </svg> Tambah Kegiatan Webinar
        </a>
            <div class="card card-solid">
        <div class="box_table">
	    <table class="table table-sm" id="daftarrekom">
        <p><b>Daftar Webinar</p>
		<thead>
		<tr>
			<th>#</th>
            <th>SERTIFIKAT</th>
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
          <td><a href="brosur_webinar/<?php echo $data['upload_sertifikat']?>"><img src="brosur_webinar/<?php echo $data['upload_sertifikat']; ?>" width="100" height="100" /></a></td>
          <td><?=$data['inp_tgl']?></td>
          <td><?=$data['peserta_webinar']?></td>
          <td><?=$data['no_skp']?></td>
          <td><?=$data['inp_kegiatan']?></td>
          <td><?=$data['ketentuan_skp']?></td>
          <td><?=$data['jumlah_skp']?></td>
				  <td>
            <!-- <a href="skp_webinar.php?id_webinar=<?=$data['id_webinar'] ?>" class="btn btn-success m-1">
            ...
            <a href="edit_webinar.php?id_webinar=<?=$data['id_webinar'] ?>" class="btn btn-success m-1">
            <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
            <path fill="#fff" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12H20A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4V2M18.78,3C18.61,3 18.43,3.07 18.3,3.2L17.08,4.41L19.58,6.91L20.8,5.7C21.06,5.44 21.06,5 20.8,4.75L19.25,3.2C19.12,3.07 18.95,3 18.78,3M16.37,5.12L9,12.5V15H11.5L18.87,7.62L16.37,5.12Z" />
            </svg> Edit</a>
            <a href="hapus_webinar.php?id_webinar=<?=$data['id_webinar'] ?>" class="btn btn-danger m1">
            <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
