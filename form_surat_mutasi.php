...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
        <center><h3>SURAT KETERANGAN PINDAH ANGGOTA<h3></center>
        </div> </br>
    <div class="panel-body">
      <!-- membuat form  -->
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_surat_mutasi.php" method="POST">
          <div class="control-group after-add-more">
            ...
            <input type="text" name="inp_noIjazah" class="form-control" style="width:1000px;">
            <label>No. STR Terbaru</label>
            <input type="text" name="inp_no_str" class="form-control" style="width:1000px;">
            ...
            <input type="text" name="inp_no_npa" class="form-control" style="width:1000px;">
