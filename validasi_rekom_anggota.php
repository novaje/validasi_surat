			...
			<div class="col-md-6">
				<form class="mt-5">
					<div class="form-group">
						Jenis Rekomendasi : <br>
						<select class="form-control" name="test" id="test" onchange="this.form.submit();">
							<option value="">-- Pilih Rekomendasi --</center></option>
							<option value="daftar_rekom_anggotaBaru.php">Rekomendasi Anggota Baru</option>
							<option value="daftar_rekom_mutasi.php">Rekomendasi Anggota Mutasi</option>
						</select>
					</div>
				</form>
			</div>				
