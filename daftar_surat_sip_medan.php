    ...
    <section class="content">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <h3 style="text-align:center">DAFTAR SURAT KETERANGAN IZIN PRAKTEK MEDAN</h3>
            <table id="daftarrekom" class="table table-sm table-bordered table-hover">
              ...
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM form_surat_izin_medan WHERE id_surat"));
                while($data=mysqli_fetch_array($ambildata)){
                  ...
                  <tr>
                    ...
                    <td><center>
                      <?php
                      $query  = "SELECT * FROM form_surat_izin_medan WHERE id_surat";
                      $run    = mysqli_query($con,$query);
                      ?>
                      <a href="formulir_sip_medan.php?id_surat=<?=$data['id_surat']?>"><i class="fas fa-file-pdf"></i> View</button></a>
                      </center>
                      </td>
                      <td>
                      <center>
                      ...
                      <td>
                      <center>
                        <form action="verif_surat_sipMedan.php?id_surat=<?php echo $data['id_surat']; ?>" method="POST">
                        ...
                        <form action="tolak_surat_sipMedan.php?id_surat=<?php echo $data['id_surat']; ?>" method="POST">
                          <input type="hidden" name="appid" value="<?php echo $data['id_surat']; ?>">
                      ...
                      <td>
                      <center> 
                          <a href="keterangan_sipMedan.php?id_surat=<?=$data['id_surat']?>"><button class="btn btn-sm btn-info">Tambah Keterangan</button></a>
                        </center>
                      </td>
