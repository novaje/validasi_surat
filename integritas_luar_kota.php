            ...
            <div class="timeline">
              ...
              <div>
                ...
                Pakta Integritas ini dibuat ditandatangani tanpa adanya paksaan dari pihak lain, untuk dapat dipergunakan sebagaimana mestinya.<br>
                  ...
                  <form role="form" action="simpan_integritas_Luarkota.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_rekomendasi" value="Rekomendasi Keluar Kota" class="form-control">
                    </div>
                    <div class="form-group">
