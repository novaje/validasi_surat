    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
        <?php 
            $query = "SELECT * FROM bakti_sosial ORDER BY id_bakti_sosial";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- Default box -->
            <a href="tambah_bakti_sosial.php" class="btn btn-primary mb-2">
    ...
    <div class="box_table">
      <table class="table table-sm">
        ...
        <tbody>
          ...
          <tr>
              <td><?= $no ?></td>
              <td><a href="galeri_foto/<?php echo $data['upload_foto']?>"><img src="galeri_foto/<?php echo $data['upload_foto']; ?>" width="60" height="50" /></a></td>
              <td><?=$data['tanggal_galeri']?></td>
              <td><?=$data['nama_kegiatan']?></td>
              <td>
					<a href="hapus_galeri.php?id_galeri=<?=$data['id_galeri'] ?>" class="btn btn-danger m1">
