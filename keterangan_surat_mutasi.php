...
<?php $id_surat_mutasi=$_GET['id_surat_mutasi'];?>
  <!DOCTYPE html>
  <html>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Ket Surat Mutasi</title>
  ...
  <div class="content-wrapper">
    ...
    ?>   
          <h3 class="card-title"><u>Surat Pernyataan Mutasi Ini di tolak</u> <br>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    ...
                    $q = "UPDATE surat_mutasi ket_tolak_surat SET ket_tolak_surat='$ket_tolak_surat' WHERE id_surat_mutasi='$id_surat_mutasi'";
                    ...
                    echo '<script type ="text/JavaScript">';
                    echo ' window.location.href="daftar_surat_mutasi.php?id='.$id_surat_mutasi.'"';
                    echo '</script>';
                  }
                ?>
            </div>
