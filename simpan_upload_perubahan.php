...
$query = "INSERT INTO lampiran_sip_perubahan (inp_nama,id_integritas,surat_rekomendasi,surat_tempat_praktik,pas_foto,fc_ktp,fc_kta,fc_ijazah,fc_str,fc_surat_izin,fc_pencabutan_str,keterangan_tempatPraktik,biaya_administrasi) 
VALUES
('$inp_nama','$id_integritas','$surat_rekomendasi','$surat_tempat_praktik','$pas_foto','$fc_ktp','$fc_kta','$fc_ijazah','$fc_str','$fc_surat_izin','$fc_pencabutan_str','$keterangan_tempatPraktik','$biaya_administrasi')";
