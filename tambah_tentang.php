        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <label for="tgl">Tanggal Tentang</label>
              <input type="date" name="tgl" class="form-control" id="" required autofocus>
              </div>
              <div class="form-group">
                <label for="isi_tentang">Isi Tentang</label>
                <textarea class="textarea" name="isi_tentang" placeholder="Place some text here" 
          ...
          if(isset($_POST['save'])){
            ...
            $query = "INSERT INTO tentang_web (tgl,isi_tentang) 
            VALUES
            ('$tgl','$isi_tentang')";
              ...
              if($con->query($query)) {
                ...
                echo '<meta http-equiv="refresh" content="1;url=tentang_web.php">';
              }
            }
