            ...
            <div class="timeline">
              ...
              <div>
                ...
                Pakta Integritas ini dibuat ditandatangani tanpa adanya paksaan dari pihak lain, untuk dapat dipergunakan sebagaimana mestinya.<br>
                  ...
                  <form role="form" action="simpan_integritas_sekolah.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="nama">Status Rekomendasi</label>
                        <input type="text" name="status_rekomendasi" value="Rekomendasi Sekolah" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="bukti_iuran">Bukti Pembayaran Iuran IDI</label>
