        ...
        <div class="row">
          ...
          <div class="card-body" col="10">
            ...
            <thead class="table-secondary">
              ...
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM lampiran_sip_perpanjang JOIN integritas_sip_perpanjang ON integritas_sip_perpanjang.id_integritas=lampiran_sip_perpanjang.id_integritas"));
                while($data=mysqli_fetch_array($ambildata)){
                  ...
                  <tr>
                    ...
                    <td>
                      <left>
                        <?php
                          $query  = "SELECT * FROM lampiran_sip_perpanjang WHERE id_sip";
                          $run    = mysqli_query($con,$query);
                        ?>
                          <left>
                          <a href="detail_sip_perpanjang.php?id_sip=<?=$data['id_sip']?>"><i class="fas fa-file-pdf"></i> Lampiran</button></a>
                      </left>
                    </td>
                    <td>
                      <center>
                      ...
                      <td>
                      <center>
                        <form action="verif_sip_perpanjang.php?id_sip=<?php echo $data['id_sip']; ?>" method="POST">
                          <input type="hidden" name="appid" value="<?php echo $data['id_sip']; ?>">
