            ...
            <div class="timeline">
              ...
              <div>
                ...
                Pakta Integritas ini dibuat ditandatangani tanpa adanya paksaan dari pihak lain, untuk dapat dipergunakan sebagaimana mestinya.<br>
                  ...
                  <form role="form" action="simpan_integritas_mutasi.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Surat Keterangan Pindah Anggota</label>
                        <div class="input-group">
                        <div class="custom-file">
                            <input type="file" name="surat_pindah" class="form-control" accept="application/pdf">
                        </div>
                    </div>
                  </div>
                    <div class="form-group">
