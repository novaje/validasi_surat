    ...
    <section class="content">
      ...
      <div class="container-fluid">
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
        <td><a href="brosur_webinar/<?php echo $data['upload_file']?>"><img src="brosur_webinar/<?php echo $data['upload_file']; ?>" width="100" height="100" /></a></td>
        <td><?=$data['inp_tgl']?></td>
