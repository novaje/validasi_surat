...
$query = "INSERT INTO integritas_anggota (inp_nama,no_npa,bukti_iuran,alamat) 
VALUES
('$inp_nama','$no_npa','$bukti_iuran','$alamat')";
...
if($con->query($query)) {
    ...
    header("location: lampiran_form_anggota.php?id=".$id_integritas."&inp_nama=".$inp_nama);
}
