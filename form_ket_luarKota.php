...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
        <center><h3>SURAT KETERANGAN KELUAR KOTA<h3></center>
        </div> </br>
    <div class="panel-body">
      <!-- membuat form  -->
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_ket_luarKota.php" method="POST">
          <div class="control-group after-add-more">
            ...
            <label>Alamat</label>
            <input type="text" name="Alamat" class="form-control" style="width:1000px;">
            ...
            <label>Dengan No. Registrasi</label>
            ...
            <input type="text" name="inp_pekerjaan" class="form-control" style="width:1000px;">
            <label>Instansi</label>
            <input type="text" name="inp_instansi" class="form-control" style="width:1000px;">
            <label>Telah Melunasi Iuran Anggota sampai Bulan</label>
            <input type="text" name="inp_tgl_iuran" class="form-control" style="width:1000px;">
            <label>No. Surat 1</label>
            <input type="text" name="inp_no_surat1" class="form-control" style="width:1000px;">
            <label>No. Surat 2</label>
            <input type="text" name="inp_no_surat2" class="form-control" style="width:1000px;">
            ...
            <label>Surat Ini dikeluarkan Tanggal/Bulan/Tahun</label>
            <input type="text" name="inp_tgl_real" class="form-control" style="width:1000px;">
            <label>Tujuan Sekolah</label>
            <input type="text" name="inp_tujuan" class="form-control" style="width:1000px;">
            <label>Nama Ketua IDI</label>
            <input type="text" name="inp_ketua" class="form-control" style="width:1000px;">
            <label>No. NPA Ketua IDI</label>
            <input type="text" name="inp_npa_ketua" class="form-control" style="width:1000px;">
