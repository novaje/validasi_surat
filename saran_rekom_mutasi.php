          ...
          <div class="row">
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    $saran = $_POST['saran'];
                    $q = "UPDATE form_mutasi saran SET saran='$saran' WHERE id_mutasi='$id_mutasi'";
                    ...
                    echo '<script type ="text/JavaScript">';  
                    echo ' window.location.href="daftar_rekom_mutasi.php?id='.$id_mutasi.'"';  
                    echo '</script>';   
                  }
                ?>
            </div>
