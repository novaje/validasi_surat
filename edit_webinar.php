  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" name="no_skp" class="form-control" value="<?php echo $data['no_skp']?>" id="" maxlength="30" minlength="3">
        </div>
        <div class="form-group">
            <label for="upload_brosur">Webinar</label>
            <input type="text" name="upload_brosur" class="form-control" value="<?php echo $data['upload_brosur']?>" id="" maxlength="30" minlength="3">
        </div>
        <div class="form-group">
            <label for="inp_tgl">Tanggal Kegiatan</label>
            <input type="date" name="inp_tgl" class="form-control" value="<?php echo $data['inp_tgl']?>" id="" maxlength="50">
        </div>
        <div class="form-group">
            <label for="ketentuan_skp">Ketentuan SKP</label>
            <input type="text" name="ketentuan_skp" class="form-control" value="<?php echo $data['ketentuan_skp']?>" id="" maxlength="50">
        </div>
        <div class="form-group">
            <label for="jumlah_skp">Jumlah SKP</label>
            <input type="text" name="jumlah_skp" class="form-control" value="<?php echo $data['jumlah_skp']?>" id="" maxlength="50">
        </div>
        <div class="form-group">
            <label for="link_pendaftaran">Link Pendaftaran</label>
            <input type="text" name="link_pendaftaran" class="form-control" value="<?php echo $data['link_pendaftaran']?>" id="" maxlength="50">
        </div>
    ...
    <?php 
          if(isset($_POST['save'])){
              ...
              $upload_brosur    = $_POST['upload_brosur'];
              $inp_tgl          = $_POST['inp_tgl'];
              $jumlah_skp       = $_POST['jumlah_skp'];
              $link_pendaftaran = $_POST['link_pendaftaran'];

             //query insert data ke dalam database
            $query = "UPDATE webinar SET inp_kegiatan='$inp_kegiatan',upload_brosur='$upload_brosur',inp_tgl='$inp_tgl',jumlah_skp='$jumlah_skp',link_pendaftaran='$link_pendaftaran' WHERE id_webinar='$id_webinar'";
              if($con->query($query)) {
