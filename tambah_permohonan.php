    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
      <div class="container-fluid">
      <a href="format_permohonan.php" class="btn btn-warning mb-3">
    ...
    <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="jenis_permohonan" class="form-control" style="width:500px;" id="" required autofocus>
		    </div>
		    <div class="form-group">
                <label for="upload_file">Upload File</label>
                <input type="file" name="upload_file" class="form-control" style="width:500px;" id="" required autofocus>
		    </div>
        ...
        <?php 
          if(isset($_POST['save'])){
              ...
              $files            = $_FILES;
              $upload_file      = $files['upload_file']['name'];
              $lokasi_file      = $files['upload_file']['tmp_name'];
              move_uploaded_file($lokasi_file, "file_permohonan/".$upload_file);

             //query insert data ke dalam database
            $query = "INSERT INTO format_permohonan (jenis_permohonan,upload_file) 
            VALUES
            ('$jenis_permohonan','$upload_file')";
              ...
              if($con->query($query)) {
                ...
                echo '<meta http-equiv="refresh" content="1;url=format_permohonan.php">';
              }
            }
