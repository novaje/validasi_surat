...
//get data dari lampiran
    ...
    $fc_str                = $inp_nama."-".$files['fc_str']['name'];
    $lokasi_str            = $files['fc_str']['tmp_name'];
    move_uploaded_file($lokasi_str, "berkas_sip/".$fc_str);

    $fc_surat_izin         = $inp_nama."-".$files['fc_surat_izin']['name'];
    $lokasi_surat_izin     = $files['fc_surat_izin']['tmp_name'];
    move_uploaded_file($lokasi_surat_izin, "berkas_sip/".$fc_surat_izin);
...
$query = "INSERT INTO lampiran_sip_perpanjang (id_integritas,inp_nama,surat_rekomendasi,surat_tempat_praktik,pas_foto,fc_ktp,fc_kta,fc_ijazah,fc_str,fc_surat_izin,fc_pencabutan_str,keterangan_tempatPraktik,biaya_administrasi) 
VALUES
('$id_integritas','$inp_nama','$surat_rekomendasi','$surat_tempat_praktik','$pas_foto','$fc_ktp','$fc_kta','$fc_ijazah','$fc_str','$fc_surat_izin','$fc_pencabutan_str','$keterangan_tempatPraktik','$biaya_administrasi')";
