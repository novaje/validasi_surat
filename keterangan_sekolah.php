...
<?php $id_surat=$_GET['id_surat'];?>
  ...
  <div class="content-wrapper">
    ...
    ?>   
          <h3 class="card-title"><u>Surat Pernyataan Sekolah Ini di tolak</u> <br>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    ...
                    $q = "UPDATE surat_ket_sekolah ket_tolak_surat SET ket_tolak_surat='$ket_tolak_surat' WHERE id_surat='$id_surat'";
                    ...
                    echo '<script type ="text/JavaScript">';  
                    echo ' window.location.href="daftar_surat_sekolah.php?id='.$id_surat.'"';  
                    echo '</script>';   
                  }
                ?>
            </div>
