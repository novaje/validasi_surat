...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  ?>
<?php $id_lampiran_sip=$_GET['id_lampiran_sip']; ?>
  ...
  <head>
    ...
    <title>DETAIL ANGGOTA BARU</title>
          ...
          <div class="row">
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    $saran = $_POST['saran'];
                    $q = "UPDATE form_rekom_sip saran SET saran='$saran' WHERE id_lampiran_sip='$id_lampiran_sip'";
                    ...
                    echo '<script type ="text/JavaScript">';  
                    echo ' window.location.href="daftar_rekom_sip.php?id='.$id_lampiran_sip.'"';  
                    echo '</script>';   
                  }
                ?>
            </div>
