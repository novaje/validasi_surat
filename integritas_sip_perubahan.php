            ...
            <div class="timeline">
              ...
              <div>
                ...
                Pakta Integritas ini dibuat ditandatangani tanpa adanya paksaan dari pihak lain, untuk dapat dipergunakan sebagaimana mestinya.<br>
                  ...
                  <form role="form" action="simpan_integritas_perubahan.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="status_rekom" value="PERUBAHAN SIP" class="form-control" readonly>
                    </div>
                    <div class="form-group">
