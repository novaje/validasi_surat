      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="card-body" col="10">
            ...
            <i class="fa fa-list" aria-hidden="true"><i><u> List Rekomendasi Anggota Lama</u></i></i><br><br>
            <thead class="table-secondary">
              ...
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM form_anggota_lama WHERE id_anggota"));
                while($data=mysqli_fetch_array($ambildata)){
                  ...
                  <tr>
                    ...
                    <td><center>
                      <?php
                      $query  = "SELECT * FROM form_anggota_lama WHERE id_anggota";
                      $run    = mysqli_query($con,$query);
                      ?>
                      <a href="formulir_anggota_lama.php?id_anggota=<?=$data['id_anggota']?>"><i class="fas fa-file-alt"></i> Formulir </a><br/><hr/>
                      <a href="detail_lampiran_anggota.php?id_anggota=<?=$data['id_anggota']?>"><i class="fas fa-file-pdf"></i> Lampiran</button></a>
                      </center>
                      </td>
                    ...
                    <td>
                      ...
                      <td>
                      <center>
                        <form action="verif_anggotaLama.php?id_anggota=<?php echo $data['id_anggota']; ?>" method="POST">
