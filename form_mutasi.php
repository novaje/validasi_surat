...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
        <center><h3>PERMOHONAN PINDAH (MUTASI)<h3></center>
        </div> </br>
    <div class="panel-body">
      <!-- membuat form  -->
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_form_mutasi.php" method="POST">
          <div class="control-group after-add-more">
            ...
            <input type="text" name="inp_tempatLahir" class="form-control">
            ...
            <br><br>
            <label>Dengan ini mengajukan permohonan untuk pindah status ke anggotaan IDI ke IDI Cabang :</label>
            <input type="text" name="inp_pindahStatus" class="form-control">
            <label>Adapun alasan kepindahan saya adalah :</label>
            <select class="form-control" name="inp_alasan_pindah">
                <option>-- PILIH --</option>
                <option>Pindah Alamat Rumah</option>
                <option>Pindah Alamat Pekerjaan</option>
                <option>Lain-lain...</option>
                <input type="text" name="inp_lain" class="form-control" placeholder="...">
              </select>
            <hr>
