            ...
            <div class="timeline">
              ...
              <div>
                ...
                Pakta Integritas ini dibuat ditandatangani tanpa adanya paksaan dari pihak lain, untuk dapat dipergunakan sebagaimana mestinya.<br>
                  ...
                  <form role="form" action="simpan_integritas_sip.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="status_rekom" class="form-control" value="SIP BARU" readonly>
                    </div>
                    <div class="form-group">
