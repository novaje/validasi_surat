  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_form_luarKota.php" method="POST">
          <div class="control-group after-add-more">
            <label>Nama Lengkap</label>
            <input type="text" name="inp_nama" class="form-control" value="<?php echo $_GET['inp_nama']; ?>" readonly>
            <input type="hidden" name="id_luarKota" class="form-control" value=" <?php echo $_GET['id_luarKota']; ?>">
            ...
            <input type="text" name="inp_noReg" class="form-control">
            <label>NPA. IDI</label>
            ...
            <input type="text" name="inp_alamatRumah" class="form-control">
            <label>No. Telpon/HP</label>
            <input type="text" name="inp_tlp" class="form-control">
            <br><br>
            <label>Mengajukan permohonan kepada Ketua/Pengurus IDI Cabang Deli Serdang untuk memberikan surat pengantar kepada saya untuk memperoleh rekomendasi dari IDI Cabang :</label>
            <input type="text" name="inp_ajukan_permohonan" class="form-control">
            <label>sebagai salah satu syarat untuk mengajukan permohonan surat izin Praktik Dokter di:</label><br>
            <label>Nama Sarana Pelayanan Kesehatan</label>
            <input type="text" name="inp_namaSarana" class="form-control">
            <label>Alamat</label>
            <input type="text" name="inp_alamatSarana" class="form-control">
            <label>Adapun praktik saya di Wilayah Deli Serdang antara lain :</label><br>
            <label>Nama Sarana Pelayanan Kesehatan</label>
            <input type="text" name="inp_saranaKesehatan" class="form-control">
            <label>Alamat</label>
            <input type="text" name="inp_alamatKesehatan" class="form-control">
            <br>
            <hr>
