...
$query = "INSERT INTO form_asn_ (inp_nama,id_lampiran,inp_tempat_lahir,inp_no_regis,inp_idi,inp_str,inp_alamat,inp_tlp,inp_alumni,inp_ijazah,sarana_kesehatan,alamat,sarana_kesehatan_2,alamat_2,sarana_kesehatan_3,alamat_3) 
VALUES 
('$inp_nama','$id_lampiran','$inp_tempat_lahir','$inp_no_regis','$inp_idi','$inp_str','$inp_alamat','$inp_tlp','$inp_alumni','$inp_ijazah','$sarana_kesehatan','$alamat','$sarana_kesehatan_2','$alamat_2','$sarana_kesehatan_3','$alamat_3')";
