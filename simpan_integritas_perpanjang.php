...
$query = "INSERT INTO integritas_sip_perpanjang (inp_nama,no_npa,bukti_iuran,alamat,jenis_keanggotaan,status_rekom) 
VALUES
...
if($con->query($query)) {
    ...
    //redirect ke halaman index.php 
     $ambil_id = (mysqli_query($con,"SELECT * FROM integritas_sip_perpanjang WHERE inp_nama='$inp_nama'"));
    while($data=mysqli_fetch_array($ambil_id)){
    $id_integritas = $data['id_integritas'];
    header("location: upload_sip_perpanjang.php?id=".$id_integritas."&inp_nama=".$inp_nama);
}
