...
if($con->query($query)) {
    ...
    //redirect ke halaman index.php 
     $ambil_idanggota  = (mysqli_query($con,"SELECT * FROM form_anggota_lama WHERE email='$email' AND inp_nama='$inp_nama'"));
    while($data=mysqli_fetch_array($ambil_idanggota)){
    $id_anggota = $data['id_anggota'];
    header("location: lampiran_anggota_lama.php?id=".$id_anggota."&inp_nama=".$inp_nama);
}
