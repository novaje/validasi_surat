...
<?php $id_surat_etika=$_GET['id_surat_etika'];?>
  <!DOCTYPE html>
  <html>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Ket Etika </title>
  ...
  <div class="content-wrapper">
    ...
    ?>   
          <h3 class="card-title"><u>Surat Etika Ini di tolak</u> <br>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    ...
                    $q = "UPDATE surat_ket_etika ket_tolak_surat SET ket_tolak_surat='$ket_tolak_surat' WHERE id_surat_etika='$id_surat_etika'";
                    ...
                    echo '<script type ="text/JavaScript">';  
                    echo ' window.location.href="daftar_surat_etika.php?id='.$id_surat_etika.'"';  
                    echo '</script>';   
                  }
                ?>
            </div>
