...
<?php
    //ambil id
    $delete_id = $_GET['id_format_permohonan'];
    ...
    //query
    $query  = "DELETE FROM format_permohonan WHERE id_format_permohonan='$delete_id'";
    //hasil
    ...
    echo '<div class="alert alert-success alert-dismissible d-flex align-items-center fade show">
         ...
         echo '<meta http-equiv="refresh" content="2;url=format_permohonan.php">';
?>
