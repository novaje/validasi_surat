...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  <head>
    ...
    <title>DAFTAR PESERTA IDI</title>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
        <?php 
            $query = "SELECT * FROM peserta_idi ORDER BY id_peserta";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- Default box -->
            <a href="tambah_data.php" class="btn btn-primary mb-2">
...
<div class="box_table">
	<table class="table table-sm">
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
        <td><img src="foto_peserta/<?php echo $data['inp_foto']; ?>" width="60" height="80" /></td>
        <td><?=$data['inp_masa_aktif']?></td>
        <td><?=$data['inp_npa']?></td>
        <td><?=$data['inp_nama']?></td>
				<td><?=$data['inp_email']?></td>
        <td><?=$data['inp_keterangan']?></td>
				<td>
					<a href="edit_peserta.php?id_peserta=<?=$data['id_peserta'] ?>" class="btn btn-success m-1">
					...
					<a href="hapus_peserta.php?id_peserta=<?=$data['id_peserta'] ?>" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
