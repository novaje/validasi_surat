      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="card-body" col="10">
            ...
            <i class="fa fa-list" aria-hidden="true"><i><u> List Rekomendasi Anggota Baru</u></i></i><br><br>
              <thead class="table-secondary">
                <tr>
                  <th scope="row" width="10%"><center>NAMA LENGKAP</center></th>
                  <th scope="row" width="10%"><center>DATA<br/></center></th>
                  <th scope="row" width="5%"><center>STATUS</center></th>
                  <th scope="row" width="8%"><center>AKSI</center></th>
                </tr>
              </thead>
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM lampiran_form_anggota WHERE id_lampiran"));
                while($data=mysqli_fetch_array($ambildata)){
                  ...
                  <tr>
                    ...
                    <td><center>
                      <?php
                      $query  = "SELECT * FROM lampiran_form_anggota WHERE id_lampiran";
                      $run    = mysqli_query($con,$query);
                      ?>
                      <a href="detail_lampiran_anggota.php?id_lampiran=<?=$data['id_lampiran']?>"><i class="fas fa-file-pdf"></i> Lampiran</button></a>
                      </center>
                      </td>
