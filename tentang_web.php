    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
        <?php 
            $query = "SELECT * FROM tentang_web ORDER BY id_tentang";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- Default box -->
            <a href="tambah_tentang.php" class="btn btn-primary mb-2">
      ...
      <table class="table table-sm">
        ...
        <tbody>
          ...
          <tr>
              <td><?= $no ?></td>
              <td><?=$data['tgl']?></td>
              <td><?=$data['isi_tentang']?></td>
              <td>
					<a href="hapus_tentang.php?id_tentang=<?=$data['id_tentang'] ?>" class="btn btn-danger m1">
