        ...
        line-height: 1px;
          ...
          <div class="rangkasurat">
              <table width="100%">
                ...
                <hr>
                    <?php
                        $ambildata  = (mysqli_query($con,"SELECT * FROM form_surat_izin_ds WHERE id_surat ='$id_surat'"));
          ...
          ?>
                ...
                dari IDI Cabang Deli Serdang sebagai kelengkapan Permohonan Surat Izin Praktik Dokter Umum yang Ke I dengan Alamat :</p> <br>
               <b><p style="text-align:center"><?=$data['inp_alamat_1']?></p></b><br>
               
                <p>Lubuk Pakam, <?=$data['inp_tgl_real']?> <br><b>Ketua Umum Terpilih</b></p> <br><br><br><br>
                <b><?=$data['inp_ketua']?></b><br>
                <b>NPA IDI. <?=$data['inp_npa_ketua']?></b>
                <br><br><br><br><br><br>
                <p>Tembusan</p>
                <ul>
