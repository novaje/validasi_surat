  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="container">
      ...
      <div class="form-group">
          ...
          <input type="date" name="tanggal" class="form-control" id="" required autofocus>
        </div>
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="file" name="foto_kegiatan" class="form-control" id="" required autofocus>
        </div>
        ...
        <?php 
          if(isset($_POST['save'])){
              ...
              $lokasi_inp_foto  = $files['foto_kegiatan']['tmp_name'];
              move_uploaded_file($lokasi_inp_foto, "bakti_sosial/".$foto_kegiatan);

             //query insert data ke dalam database
            $query = "INSERT INTO bakti_sosial (tanggal,nama_kegiatan,foto_kegiatan) 
            VALUES
            ('$tanggal','$nama_kegiatan','$foto_kegiatan')";
              ...
              if($con->query($query)) {
                ...
                echo '<meta http-equiv="refresh" content="1;url=bakti_sosial.php">';
              }
            }
