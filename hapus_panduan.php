...
<?php
    ...
    //query
    $query  = "DELETE FROM panduan_rekomendasi WHERE id_panduan='$delete_id'";
    //hasil
    ...
    echo '<div class="alert alert-success alert-dismissible d-flex align-items-center fade show">
         ...
         echo '<meta http-equiv="refresh" content="2;url=panduan_rekomendasi.php">';
?>
