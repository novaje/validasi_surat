  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_lampiran_mutasi.php" method="POST" enctype="multipart/form-data">
          <div class="control-group after-add-more">
            ...
            <input type="hidden" name="dibuat_oleh" value="<?php echo $data_user['id_admin'] ?>" class="form-control" style="width:1000px;">
