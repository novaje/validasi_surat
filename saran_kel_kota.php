...
if ($data_user['level']!="admin" && $data_user['level']!="tamu") {
  ...
  ?>
<?php $id_luarKota=$_GET['id_luarKota']; ?>
  ...
  <head>
    ...
    <title>DETAIL KELUAR KOTA</title>
          ...
          <div class="row">
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['save'])) {
                    $saran = $_POST['saran'];
                    $q = "UPDATE form_luarkota saran SET saran='$saran' WHERE id_luarKota='$id_luarKota'";
                    ...
                    echo '<script type ="text/JavaScript">';  
                    echo ' window.location.href="daftar_rekom_keluarKota.php?id='.$id_luarKota.'"';  
                    echo '</script>';   
                  }
                ?>
            </div>
