...
<?php
    ...
    //query
    $query  = "SELECT * FROM lampiran_sip_perubahan WHERE id_lampiran='$id_lampiran'";
    //hasil
        ...
        <div class="row">
          ...
          <h3 style="text-align:center">DETAIL REKOMENDASI SIP</h3>
            <table border="1" id="daftarbuku" class="table table-striped">
              ...
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM lampiran_sip_perubahan WHERE id_lampiran='$id_lampiran'"));
