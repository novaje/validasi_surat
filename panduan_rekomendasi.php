    ...
    <section class="content">
      <div class="card-body">
        <div class="row">
          ...
          <?php 
            $query = "SELECT * FROM panduan_rekomendasi ORDER BY id_panduan";
            $result = mysqli_query($con, $query);
        ?>
            <div class="container-fluid">
            <a href="tambah_panduan.php" class="btn btn-primary mb-2">
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
            <td><?=$data['judul_rekomendasi']?></td>
            <td><a href="panduan/<?php echo $data['nama_panduan']; ?>"><?php echo $data['nama_panduan']; ?></left></td>
				<td>
					<a href="hapus_panduan.php?id_panduan=<?=$data['id_panduan'] ?>" class="btn btn-danger m1">
