  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="simpan_form_sip_ds.php" method="POST">
          <div class="control-group after-add-more">
            ...
            <label>Cabang</label>
            <input type="text" name="inp_cabang" value="Deli Serdang" readonly class="form-control" style="width:1000px;">
