  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- gunakan tanda [] untuk menampung array  -->
         <form action="simpan_uploadSip.php" method="POST" enctype="multipart/form-data">
          <div class="control-group after-add-more">
            ...
            <input type="file" name="fc_ijazah" class="form-control" accept="application/pdf" required> </br>
            <label>Salinan STR Asli</label>
            <input type="file" name="surat_keterangan" class="form-control" accept="application/pdf" required> </br>
            ...
            <input type="file" name="fc_pencabutan_str" class="form-control" accept="application/pdf" required> </br>
            <label>Surat Keterangan dari Tempat Praktik/Instansi (RS/Klinik)</label>
            <input type="file" name="keterangan_tempatPraktik" class="form-control" accept="application/pdf" required> </br>
            <label>Biaya Administrasi Rekomendasi Dokter Umum/Spesialis</label>
            <input type="file" name="biaya_administrasi" class="form-control" accept="application/pdf" required> </br>
            <br>
            <hr>
          </div>
