        ...
        <div class="row">
          ...
          <div class="card-body" col="10">
            ...
            <thead class="table-secondary">
              ...
              <tbody>
                <?php
                $ambildata  = (mysqli_query($con,"SELECT * FROM lampiran_sip JOIN integritas_sip ON integritas_sip.id_integritas=lampiran_sip.id_integritas"));
                while($data=mysqli_fetch_array($ambildata)){
                  ...
                  <tr>
                    ...
                    <td>
                      <left>
                        <?php
                          $query  = "SELECT * FROM lampiran_sip WHERE id_lampiran_sip";
                          $run    = mysqli_query($con,$query);
                        ?>
                          <left>
                          <a href="detail_lam_sip.php?id_lampiran_sip=<?=$data['id_lampiran_sip']?>"><i class="fas fa-file-pdf"></i> Lampiran</button></a>
                      </left>
                    </td>
                    <td>
                      <center>
                      ...
                      <td>
                      <center>
                        <form action="verif_sip.php?id_lampiran_sip=<?php echo $data['id_lampiran_sip']; ?>" method="POST">
                          <input type="hidden" name="appid" value="<?php echo $data['id_lampiran_sip']; ?>">
